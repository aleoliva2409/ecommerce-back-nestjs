...
export class FirstMigration1697928317247 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("id" SERIAL NOT NULL, "is_paid" boolean NOT NULL DEFAULT false, "status" "public"."orders_status_enum" NOT NULL, "tax" numeric(5,4), "paid_at" date, "sub_total" numeric(10,2) NOT NULL, "total" numeric(10,2) NOT NULL, "total_items" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "userId" integer, CONSTRAINT "PK_710e2d4957aa5878dfe94e4ac2f" PRIMARY KEY ("id"))`);
