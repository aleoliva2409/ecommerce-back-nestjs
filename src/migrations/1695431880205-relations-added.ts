...
export class RelationsAdded1695431880205 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "variants_in_orders" ("id" SERIAL NOT NULL, "quantity" integer NOT NULL, "orderId" integer NOT NULL, "productId" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_67ea94e9f3dd97cef3905996f32" PRIMARY KEY ("id"))`);
